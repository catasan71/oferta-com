            ...
            <div className="space-y-2.5">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold text-slate-800 dark:text-slate-200 uppercase tracking-wider">
                  Plată Rapidă 1-Click (Express Checkout)
                </span>
              ...
              >
                {isProcessing ? (
                  <>
                    ...
                    <span>
                      {processingMethod === 'REVOLUT_PAY' && 'Se confirmă prin Revolut Pay...'}
                      {processingMethod === 'APPLE_PAY' && 'Se confirmă prin Apple Pay...'}
                      {processingMethod === 'GOOGLE_PAY' && 'Se confirmă prin Google Pay...'}
                      {(!processingMethod || processingMethod === 'CARD') && 'Se confirmă debitarea pe card...'}
                    </span>
                  </>
                ) : (
                  <>
