          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                <span>{currentPlan === 'STARTER' ? 'Plan STARTER' : 'Plan FREE'}</span>
              </button>
              ...
              {currentPlan === 'FREE' ? (
                ...
                <button
                  type="button"
                  onClick={onOpenRevolutCheckout}
                  className="flex items-center gap-1.5 px-2.5 py-1.5 bg-emerald-500/15 hover:bg-emerald-500/25 text-emerald-400 border border-emerald-500/30 rounded-xl text-xs font-bold transition-all cursor-pointer"
                  title="Abonament Activ • Deschide Revolut & Facturi Proforme"
                >
                  <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400" />
                  <span className="hidden sm:inline">Plăți & Proforme</span>
                </button>
              )}
            </div>
